...
#define DFR_DEVICE_UPDATE_FB_CONTENT_RSVD_VALUE_0 0x00000001
...
#define DFR_FRAMEBUFFER_UPDATED_KEY 0x5544434c // UDCL
...
#define DFR_FB_UPDATE_RETRANSMIT_MAX 2
...
typedef struct _DFR_FRAMEBUFFER_UPDATE_RESPONSE {
	UINT32 ResponseHeader;
	UINT32 Reserved1;
	UINT64 Reserved2;
	UINT32 ResponseMessageKey;
	...
	UINT8 FrameId;
	UCHAR Reserved5[7];
} DFR_FRAMEBUFFER_UPDATE_RESPONSE, *PDFR_FRAMEBUFFER_UPDATE_RESPONSE;
#pragma pack(pop)
